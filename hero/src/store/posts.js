...
export const posts = ref([
  ...
  },
  {
    ...
    comunidadess: 1,
    verificado: true,
    bio: 'Vivo para aprender, servir e inspirar bondade no dia a dia.',
    tempo: '2025-09-14T10:21:30.000Z',
    conteudo: 'Hoje conseguimos alimentar 3 gatos de rua❤️ ',
    imagem:
      'https://cdn0.peritoanimal.com.br/pt/posts/1/7/3/o_que_os_gatos_de_rua_comem_23371_1_600.jpg',
    curtidas: 2,
    comentarios: 0,
    compartilhamentos: 1,
    comentariosLista: [],
...

  {
    ...
    bio: 'Valorizo integridade, escuta e amizade sincera acima de tudo.',
    conteudo: 'Organizamos a entrega de 50 cestas básicas esta semana.',
    imagem:
      'https://s2-g1.glbimg.com/SInmB-nwOowUty1ps6TmdmJEuBQ=/0x0:877x470/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_59edd422c0c84a879bd37670ae4f538a/internal_photos/bs/2021/I/p/qbF3BBQBeDtWV0iJL7Ag/cestas-basicas-doacao-alimentos-uberaba-23-07-2021.jpg',
    curtidas: 5,
    comunidadess: 1,
    comentarios: 2,
    compartilhamentos: 1,
  ...
  },
  {
    ...
    comunidade: 'Mãos Solidárias',
    bio: 'Procuro ser luz nos dias nublados de quem cruza meu caminho',
    pontos: 35,
    postagens: 1,
    verificado: false,
    tempo: '2025-09-12T11:05:44.000Z',
    conteudo:
      'Precisamos de voluntários para a arrecadação deste sábado!! Por favor quem poder venha nós ajuda🙏',
    imagem: '',
    curtidas: 3,
    comunidadess: 1,
    comentarios: 0,
  ...
  },
  {
    ...
    curtidas: 4,
    postagens: 1,
    bio: 'Sou movida por compaixão e pelo desejo de deixar marcas positivas.',
    comentarios: 1,
    compartilhamentos: 0,
    comentariosLista: [
...

  {
    ...
    postagens: 1,
    comunidadess: 1,
    bio: 'Pequenos gestos, grandes mudanças: minha meta é fazer o bem sempre que possível.',
    verificado: false,
    tempo: '2025-09-10T14:30:00.000Z',
    conteudo: 'Doações arrecadas na ultima semana, obrigada a todos os participantes🙏',
    imagem:
      'https://files.adventistas.org/noticias/pt/2019/11/Materiais-escolares-arrecadados_edited.jpg',
    curtidas: 3,
    comentarios: 0,
    compartilhamentos: 0,
    comentariosLista: [],
  },
  {
    ...
    bio: 'Acredito no poder do respeito e da empatia para transformar o mundo.',
    comunidade: 'Educa Jovem',
    pontos: 15,
    postagens: 1,
    verificado: true,
    ...
    imagem:
      'https://static.wixstatic.com/media/f6bff0_b5b51c681d114017b95955d768b97e2b~mv2.jpg/v1/fill/w_1000,h_563,al_c,q_85,usm_0.66_1.00_0.01/f6bff0_b5b51c681d114017b95955d768b97e2b~mv2.jpg',
    curtidas: 2,
    comentarios: 1,
    compartilhamentos: 0,
    comunidadess: 1,
    comentariosLista: [{ usuario: 'Lara Mendes', conteudo: 'Meus filhos adoraram!', tempo: '1d' }],
  },

  {
    ...
    pontos: 50,
    comunidadess: 1,
    bio: 'Espalho gentileza onde passo e aprendo todos os dias a ser alguém melhor.',
    verificado: true,
    tempo: '2025-09-08T10:00:00.000Z',
    conteudo: 'Visitamos um asilo e realizamos atividades de convivência com os idosos.',
    imagem:
      'https://agazetarm.com.br/wp-content/uploads/2025/02/WhatsApp-Image-2025-02-14-at-14.39.52.jpeg',
    curtidas: 6,
    comentarios: 2,
    compartilhamentos: 1,
    comentariosLista: [
